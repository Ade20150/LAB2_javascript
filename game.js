function Bear() {
  ...
  this.move = function (xDir, yDir) {
    this.fitBounds(); //we add this to keep the bear in board
...
class Bee {
  constructor(beeNumber) {
    ...
    this.display = function () {
      //adjust position of bee and display it this.fitBounds();//add this to adjust to bounds this.htmlElement.style.left = this.x + "px"; this.htmlElement.style.top = this.y + "px"; this.htmlElement.style.display = "block";
...
function makeBees() {
  ...
  while (i <= nbBees) {
    var num = i;
    var bees = new Bee(num); //create object and its IMG element
